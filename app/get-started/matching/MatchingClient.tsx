      ...
      <div className="flex-1 min-h-0 flex flex-col lg:flex-row">
        <div className="w-full lg:w-1/2 flex flex-col overflow-y-auto h-full">
          ...
          <div className="relative h-full flex flex-col p-4">
            ...
            {/* Background image */}
            <div className="absolute inset-0 bg-[url('/meetlyr-matching.png')] bg-cover bg-no-repeat bg-center"></div>
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between gap-2 px-4 pb-5 w-full">
                <IoMdArrowRoundBack
                  size={24}
                  className="cursor-pointer w-10 h-10 rounded-full p-2 flex items-center justify-center text-[#2f1107] hover:bg-[#2f1710] hover:text-white"
                  onClick={() => router.back()}
                />
                <Link href="/">
                  <Image
                  ...
                  <div className="flex-1 overflow-y-auto flex flex-col gap-6 text-center px-4 pt-10 pb-4">
                    ...
                    {errorMessage && (
                      errorMessage === "User already exists" ? (
                        <div className="flex bg-white shadow-md rounded-md py-2 flex-col gap-1 items-center">
                          ...
                          <Link
                            href="/login"
                            className="underline text-blue-600 font-semibold text-base"
                          >
                            Login to your account
                          </Link>
                        </div>
                      ) : (
                        <div className="bg-white shadow-md rounded-md flex items-center justify-center gap-1 py-2">
                          <CgDanger size={16} className="text-red-600" />
