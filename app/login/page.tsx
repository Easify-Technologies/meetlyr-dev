                ...
                <div className="flex-1 min-h-0 overflow-y-auto flex flex-col justify-center items-center">
                    <form className="flex flex-col  w-full gap-4 max-w-sm">
                        ...
                        <div className="flex-1 flex flex-col justify-center items-center">
                            ...
                            <Link href="/get-started" className='bg-[#507dbc] h-12 px-4 py-2 text-white inline-flex items-center justify-center text-center rounded-full w-full cursor-pointer text-sm md:text-base font-medium transition-colors whitespace-nowrap hover:bg-[#507dbc]/80'>
                                Create an Account
                            </Link>
                        </div>
                    </form>
