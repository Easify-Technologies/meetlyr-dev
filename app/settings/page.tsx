                                                ...
                                                <div className="flex-1 flex flex-col p-4 lg:p-0 ">
                                                    <div className="flex flex-col gap-4">
                                                        ...
                                                        <div className="px-4 flex flex-col gap-4">
                                                            ...
                                                            <button onClick={handleLogout} data-slot="button" className="inline-flex mb-20 cursor-pointer items-center justify-center whitespace-nowrap text-sm md:text-base font-medium transition-all select-none disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg:not([class*='size-'])]:size-4 shrink-0 [&amp;_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive border border-secondary bg-background text-foreground hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50 h-12 px-4 py-2 rounded-full w-full gap-2">
